        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
              ...
              <h2 className="mb-4 text-3xl font-bold font-cursive sm:text-4xl md:text-[40px]" style={{color:"rgba(147,189,203,255)"}}>
      ...
      <div className="absolute bottom-0 right-0 z-[-1]">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stop-color="rgba(147,189,203,255)" stop-opacity="0.36" />
              <stop offset="1" stop-color="rgba(147,189,203,255)" stop-opacity="0" />
              <stop offset="1" stop-color="rgba(147,189,203,255)" stop-opacity="0.096144" />
            </linearGradient>
          </defs>
        </svg>
      </div>
